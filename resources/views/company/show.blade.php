...
@section('content')
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <br>
            <h4>TAGs: <span style="color:blue;">{{ $job->tags->count() }}</span>
        ...
        <div class="col-md-4">
            <div class="card bg-light p-3">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {!! Html::linkRoute('company.edit', 'Edit', array('company'=>$job->company->id, 'job'=>$job->id), array('class' => 'btn btn-warning btn-block')) !!}
                    </div>
                    <div class="col-sm-6">
                        {!! Form::open(['route' => ['company.destroy', $job->id], 'method' => 'DELETE']) !!}
                    ...
                    <div class="col-sm-12">
                        ...
                        {!! Html::linkRoute('company.dashboard', '<< See All', [], ['class' => 'btn btn-light btn-block']) !!}
                    </div>
                </div>
            </div>
        </div>
